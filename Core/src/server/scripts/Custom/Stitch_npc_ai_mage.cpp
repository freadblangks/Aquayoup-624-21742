...
public: Stitch_npc_ai_mage() : CreatureScript("Stitch_npc_ai_mage") { }
		...
		struct Stitch_npc_ai_mageAI : public ScriptedAI
		{
			...
			uint32 BrancheSpe = 1;													// Choix de la Specialisation : Arcane = 1, Feu = 2, Givre = 3
			...
			uint32 Cooldown_Spell_Heal = 5000;											// Cooldown pour la frequence du heal
			...
			uint32 Buf_branche2_liste[2] = { 79849, 140468 };							// Armure de la fournaise 79849 (s10/lvl si touche, crotique +5%), Lueur de la flamme 140468 (dmg -20%, cumulable)
			uint32 Buf_branche3 = 0;
			uint32 Buf_branche3_liste[2] = { 111264, 1459 };							// Garde glaciale 111264 (3 melees 30s), Illumination des Arcanes 1459
			...
			uint32 branche1_2[3] = { 145434, 145434,128192 };							// Deflagration des Arcanes 145434,Lance d'esprit 128192
			...
			uint32 branche3_agro[4] = { 140485, 84714, 2139, 124935 };					// Piège à runes gele 140485 (gele 20s,20m), Sol gele 84714, Contresort 2139, Torrent 124935
			...
			void Init_AI()
			{
				...
				case 1: // Si Arcane --------------------------------------------------------------------------------------------------------------------------
					...
					// Tirages aleatoires des spells Arcane 
				...
				case 2: // Si Feu -------------------------------------------------------------------------------------------------------------------------
					...
					// Tirages aleatoires des spells Feu 
				...
				case 3: // Si Givre -------------------------------------------------------------------------------------------------------------------------
					...
					// Tirages aleatoires des spells Givre 
