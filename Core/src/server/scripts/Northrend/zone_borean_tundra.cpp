...
const char* GOSSIP_ITEM_TOM_HEGGER = "Que savez-vous du Culte des damnes ?";
const char* GOSSIP_ITEM_GUARD_MITCHELLS = "Depuis combien de temps travaillez-vous pour le Culte des damnes ?";
const char* GOSSIP_ITEM_SALTY_JOHN_THORPE = "J'ai une raison de croire que vous etes implique dans l'activite du Culte des damnes";
